...
def transform(input_list):
    ...
    for key in input_list:
        if 'question1' in key or 'question2' in key:
            question_dictionary = {}
            question_num = key[-1]
            question_dictionary[f'question'] = input_list[key]
            question_dictionary[f'A'] = input_list[f'A_{question_num}']
            question_dictionary[f'B'] = input_list[f'B_{question_num}']
            question_dictionary[f'C'] = input_list[f'C_{question_num}']
            question_dictionary[f'D'] = input_list[f'D_{question_num}']
            question_dictionary[f'reponse'] = input_list[f'reponse{question_num}']
            processed_list.append(question_dictionary)
...
output_dictionary = transform(output_parser.parse(input_string))
